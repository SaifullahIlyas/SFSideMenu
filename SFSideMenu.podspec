#
#  Be sure to run `pod spec lint SFSideMenu.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "" => "saifullahilyas907@gmail.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "saifullah@mobinspire.me" }
  ...
  spec.source       = { :git => "https://github.com/SaifullahIlyas/SFSideMenu.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "SFSideMenu/SFSideMenu/Source/*.{swift}"
